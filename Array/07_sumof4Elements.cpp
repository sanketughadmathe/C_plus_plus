    ...
    for (size_t j = i + 1; j < arr.size(); j++)
    {
      ...
      for (size_t k = j + 1; k < arr.size(); k++)
      {
        ...
        for (size_t l = 0; l < arr.size(); l++)
        {
          ...
          int lastElement = arr[l];

          if (firstElement + secondElement + thirdElement + lastElement == 80)
          {
            cout << "Pairs with sum 80 are (" << firstElement << ", " << secondElement << ", " << thirdElement << ", " << lastElement << ")" << endl;
          }
        }
      }
    }
